...
<body>
    ...
    <div class="contents shadow p-3 bg-light rounded mx-auto">
        <div class="form-group">
            <img class="rounded-circle mt-2" src="../images/samoul.jpg" alt="" width="30" hight="20">
            <span class="my-6  h6">Samoul-Kh</span>
            <div class="group-d_e mt-2 float-right">
                <a href=""><i class="fa fa-check-circle-o" style="font-size:25px; color:blue;"></i> </a>
                <a href=""><i class="fa fa-times-circle-o" style="font-size:25px; color:red;"></i> </a>
            </div>
        </div>
        <hr>
        <div class="form-group">
